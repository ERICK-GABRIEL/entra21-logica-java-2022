package br.com.entra21.pratica.matrizes;
...
public class Main {
	...
	public static String escreverMenu() {
		String menu = "";
		menu += "Escolha uma opção do menu abaixo:\n\n";
		menu += "0 - Sair\n";
		menu += "2 - Criar matrizes de 2 níveis inicializados para cada tipo primitivo e exibir o tamanho deles no console\n";
		menu += "1 - Criar matrizes de 2 níveis para cada tipo primitivo e exibir o tamanho deles no console\n";
		...
		menu += "5 - Criar uma matriz de inteiros inicializado , para percorrer: Do inicio ao fim, Do fim ao inicio, Para exibir valores\n";
	...
	public static void initializeMatrizTwoLevel() {
		...
		boolean matrizBooleans[][] = { // Regular porque tem a mesma capacidade de index por vetor
		...
		System.out.println(
				"matrizBytes tamanho = " + matrizBytes.length + " e cada vetor tem tamanho +" + matrizBytes[0].length);
		System.out.println("matrizShort tamanho = " + matrizShorts.length + " e cada vetor tem tamanho +"
				+ matrizShorts[0].length);
		System.out.println(
				"matrizInt tamanho = " + matrizChars.length + " e cada vetor tem tamanho +" + matrizInts[0].length);
		System.out.println(
				"matrizLongs tamanho = " + matrizLongs.length + " e cada vetor tem tamanho +" + matrizLongs[0].length);
		System.out.println("matrizFloats tamanho = " + matrizFloats.length + " e cada vetor tem tamanho +"
				+ matrizFloats[0].length);
